...
const Hero = () => {
    ...
    return (
        <section className="max-w-7xl mx-auto space-y-4 sm:space-y-6 pt-16 sm:pt-20 mb-6 px-3 sm:px-4 md:px-0">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
                ...
                <div className="lg:col-span-8 bg-retro-white dark:bg-zinc-100 bento-card rounded-2xl p-4 sm:p-6 relative overflow-hidden retro-grain border-4 border-black/5">
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="w-full md:w-2/3 space-y-4">
                            ...
                            {/* Retro Data Grid */}
                            <div className="grid grid-cols-3 gap-0 border-2 border-black text-[9px] sm:text-[10px] md:text-xs font-bold uppercase bg-zinc-50 font-pixel tracking-widest">
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-3 pt-4">
                                <div className="flex flex-wrap gap-2 sm:gap-3">
                                    {portfolioData.hero.actions.map((action, index) => (
                                        ...
                                        >
                                            <span className="bg-black text-white px-2 py-1 rounded text-[9px] sm:text-[10px] font-bold group-hover:bg-primary group-hover:text-black transition-colors uppercase text-center">
                                                {action.text}
                                            </span>
                                        </a>
                                    ))}
                ...
                <div className="lg:col-span-4 bg-zinc-200 bento-card rounded-2xl p-3 sm:p-4 flex flex-col items-center justify-center relative overflow-hidden retro-grain border-4 border-zinc-300">
