...
const Experience = () => {
    return (
        <section className="max-w-7xl mx-auto mb-6 px-4 md:px-0" id="experience">
            <div className="bg-retro-charcoal bento-card rounded-3xl p-8 relative overflow-hidden border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,0.2)]">
                ...
                {/* Terminal Header */}
                <div className="flex items-center justify-between mb-6 border-b border-retro-green/30 pb-4">
                    <h2 className="text-2xl font-pixel uppercase tracking-widest text-retro-green flex items-center gap-2">
                        <span className="animate-pulse">_</span> SYSTEM_BOOT_LOG: CAREER_HISTORY
                    </h2>
                    <div className="text-xs font-pixel text-retro-green/50">
                        v2.0.24 [STABLE]
                    </div>
                </div>

                <div className="space-y-8 font-pixel text-lg">
