...
// ⚡ BOLT OPTIMIZATION: Hoisted static data out of component
// Pre-computing skillsList avoids redundant O(N) Array.flatMap and String.split operations on every render.
const SKILLS_LIST = portfolioData.skills.flatMap(s => s.items.split(', '));

// Hoisting large static objects avoids reallocating them in memory on every render.
