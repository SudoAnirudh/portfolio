...
// Hoisting these static maps and derived arrays outside of the component prevents them
// from being re-created and re-allocated on every single render cycle.
