...
// ⚡ Bolt: Hoisted static variables outside of the component render loop
// Performance optimization to prevent redundant memory allocations and O(N) operations
// like `flatMap` and `split` on every render cycle.
