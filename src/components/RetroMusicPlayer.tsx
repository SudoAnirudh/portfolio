                ...
                <div className="bg-zinc-900 border-x-2 border-b-2 border-black p-3 space-y-3 relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-between no-drag">
                        ...
                        <div className="flex gap-1">
                            <button onClick={prevTrack} className="w-8 h-8 bg-zinc-300 border-b-4 border-r-4 border-zinc-600 active:border-0 active:translate-y-1 active:bg-zinc-400 flex items-center justify-center hover:bg-white text-zinc-900" aria-label="Previous Track" title="Previous Track">
                                <span className="material-symbols-outlined text-lg" aria-hidden="true">skip_previous</span>
                            </button>
                            <button onClick={togglePlay} className="w-10 h-10 bg-zinc-300 border-b-4 border-r-4 border-zinc-600 active:border-0 active:translate-y-1 active:bg-zinc-400 flex items-center justify-center hover:bg-white text-zinc-900" aria-label={isPlaying ? "Pause" : "Play"} title={isPlaying ? "Pause" : "Play"}>
                                <span className="material-symbols-outlined text-xl" aria-hidden="true">{isPlaying ? "pause" : "play_arrow"}</span>
                            </button>
                            <button onClick={nextTrack} className="w-8 h-8 bg-zinc-300 border-b-4 border-r-4 border-zinc-600 active:border-0 active:translate-y-1 active:bg-zinc-400 flex items-center justify-center hover:bg-white text-zinc-900" aria-label="Next Track" title="Next Track">
