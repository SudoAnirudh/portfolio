                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8">
                    {portfolioData.projects.map((project, index) => {
                        ...
                        return (
                            <button
                                key={index}
                                className="group cursor-pointer text-left block w-full focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-retro-orange focus-visible:ring-offset-2"
