            ...
            <div className="bg-retro-white bento-card rounded-3xl p-5 sm:p-8 relative overflow-hidden retro-grain border-4 border-black/10 h-full flex flex-col justify-between">
                <div className="flex flex-col items-start gap-8">
                    <div className="w-full">
                        ...
                        <div className="text-base sm:text-lg md:text-xl font-medium leading-relaxed font-body text-zinc-700 space-y-4 sm:space-y-6 max-w-4xl">
                ...
                <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 border-t-2 border-black/10 pt-6 sm:pt-8">
