        ...
        const updateMousePos = (e: MouseEvent) => {
            ...
            if (reducedMotion) {
                ...
                staticPosRafId = requestAnimationFrame(() => {
                    // PERFORMANCE: Throttle React state updates from high-frequency mousemove events using requestAnimationFrame to prevent main thread blocking and layout thrashing
