                                ...
                                <div className="bg-zinc-200 p-5 sm:p-8 border-b-4 lg:border-b-0 lg:border-r-4 border-black border-dashed flex flex-col z-0">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-3 sm:gap-4">
                                            <a href={portfolioData.personal.social.github} aria-label="GitHub Profile" className="w-12 h-12 border-2 border-black flex items-center justify-center hover:bg-black hover:text-white transition-colors">
                                                <span className="material-symbols-outlined" aria-hidden="true">code</span>
                                            </a>
                                            <a href={portfolioData.personal.social.linkedin} aria-label="LinkedIn Profile" className="w-12 h-12 border-2 border-black flex items-center justify-center hover:bg-blue-700 hover:text-white transition-colors">
                                                <span className="material-symbols-outlined" aria-hidden="true">work</span>
                                            </a>
                                            <a href={`mailto:${portfolioData.personal.email}`} aria-label="Send Email" className="w-12 h-12 border-2 border-black flex items-center justify-center hover:bg-red-500 hover:text-white transition-colors">
